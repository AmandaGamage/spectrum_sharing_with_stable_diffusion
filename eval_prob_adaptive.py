...
def get_target_dataset(name: str, train=False, transform=None, target_transform=None):
    dataset = split_data.Spectrogram(root=DATASET_ROOT, transform=transform, target_transform=target_transform)
    return dataset
...
def main():
    ...
    # dataset args
    parser.add_argument('--dataset', type=str, default='spectrogram',
                        choices=['spectrogram'])
